...
const Navbar = () => {
  ...
  return (
    <nav
      className={` 
        md:gap-[1vw] items-center bg-bg relative max-md:text-[2.4vw] uppercase font-bold tracking-wider h-[120px]  flex justify-center p-5 pb-0 text-white`}
    >
      <Link
        href={"/"}
        className={`${
      ...
      <Link
        href={"/articles"}
        className={`${
          /\barticles/.test(path) && " bg-gradient-to-r from-s1 to-s2"
