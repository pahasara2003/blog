...
const BlogCard = ({
  ...
  return (
    <Link href={`/posts/${slug}`}>
      <Card className="py-4 w-[300px] rounded-sm shadow-2xl  ring-gray-100 ring-1">
        ...
        <CardBody>
          <p className="text-default-500 h-[100px]  after:inset-0 relative after:absolute after:bg-gradient-to-b from-transparent overflow-hidden to-white">
            {description}
          </p>
        </CardBody>
